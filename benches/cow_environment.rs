...
fn bench_clone_cost(c: &mut Criterion) {
    ...
    // Empty environment
    let empty = MettaEnvironment::default();
...
criterion_group!(clone_benches, bench_clone_cost,);

criterion_group!(make_owned_benches, bench_make_owned_cost,);

criterion_group!(concurrent_benches, bench_concurrent_reads,);

criterion_group!(multi_clone_benches, bench_multi_clone_mutate,);

criterion_group!(read_benches, bench_read_operations,);

criterion_group!(workload_benches, bench_typical_workload,);
