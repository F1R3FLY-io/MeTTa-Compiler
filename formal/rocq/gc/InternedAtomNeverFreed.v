...
Section InternedAtomModel.
  ...
  Hypothesis release_only_sideboxed : forall b, Released b -> SideBoxed b.
  ...
  Hypothesis interned_not_sideboxed : forall b, Interned b -> ~ SideBoxed b.
  ...
  Proof.
    intros b Hint Hrel.
    apply (interned_not_sideboxed b Hint).
    apply (release_only_sideboxed b Hrel).
  Qed.
  ...
  Proof.
    intros b Hint Hrel.
    exact (interned_atom_bytes_never_released b Hint Hrel).
  Qed.
