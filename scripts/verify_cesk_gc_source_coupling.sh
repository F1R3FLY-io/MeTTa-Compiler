...
assert_after_before "src/backend/eval/cesk/index_heap.rs" "pub(crate) fn sweep_after_concurrent_mark" "committed > max_bytes().max(CAP_FLOOR.load(Ordering::Relaxed))" "heap.mark(&addrs);"
