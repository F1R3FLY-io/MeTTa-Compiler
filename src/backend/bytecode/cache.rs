...
use crate::backend::models::{
    register_root_provider, MettaValue, MettaValueTrait, RootProvider, ValueView,
};
...
static CAN_COMPILE_CACHE: LazyLock<RwLock<LruCache<u64, bool, IdentityU64BuildHasher>>> =
    LazyLock::new(|| {
...
static BYTECODE_CACHE: LazyLock<RwLock<LruCache<u64, Arc<BytecodeChunk>, IdentityU64BuildHasher>>> =
    LazyLock::new(|| {
