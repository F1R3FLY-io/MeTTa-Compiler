...
impl Opcode {
    ...
    pub fn immediate_size(self) -> usize {
        match self {
            ...
            | Self::GetArity | Self::ApplySubst | Self::Add | Self::Sub | Self::Mul | Self::Div
            ...
            | Self::MorkLookup | Self::MorkMatch | Self::MorkInsert | Self::MorkDelete => 0,
            ...
            | Self::JumpTable | Self::Call | Self::TailCall
...
mod tests {
    ...
    fn test_invalid_opcode() {
        ...
        assert!(Opcode::from_byte(0x20).is_none()); // Gap after value creation
    }
