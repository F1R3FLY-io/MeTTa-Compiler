...
(*****************************************************************************)
(* TLA+ model of the historical skipped-old young-marker design.             *)
(*                                                                           *)
(* The live Phase C minor is now modeled by ConservativeMinorMark.tla: it     *)
(* traverses the whole reachable graph and marks only young nodes. This file  *)
(* remains as a discriminator for the rejected cheaper design: a minor that   *)
(* MARKS ONLY YOUNG nodes and skips old nodes is sound IFF there is no        *)
(* old→young σ edge, and the allocator reuse policy is what establishes that  *)
(* invariant.                                                                *)
(*                                                                           *)
