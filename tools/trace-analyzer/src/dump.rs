...
fn print_event_human(event: &TraceEvent, reader: &TraceReader) {
    ...
    let span_str = if let Some(span) = &event.expr_span {
        ...
        format!(
            " {}:{}-{}:{} {}",
            span.start_row, span.start_col, span.end_row, span.end_col, file
        )
    } else {
        String::new()
    };
...
fn print_kind_details(kind: &TraceEventKind) {
    match kind {
        ...
        TraceEventKind::SpecialForm { form_name, phase } => {
            println!(
                "  SpecialForm {{ form: \"{}\", phase: \"{}\" }}",
                form_name, phase
            );
        }
        TraceEventKind::PatternMatch {
            pattern,
            value,
            success,
            bindings,
            ...
            println!(
                "  PatternMatch {{ pattern: {}, value: {}, success: {}, bindings: {} }}",
                format_trace_value(pattern),
        ...
        TraceEventKind::TypeOperation {
            ...
            println!(
                "  TypeOperation {{ op: \"{}\", subject: {}, result: {} }}",
                op,
                format_trace_value(subject),
                rt
            );
        }
        TraceEventKind::ApplicativePreEval {
            operator,
            arg_indices,
            source,
        } => {
            println!(
                "  ApplicativePreEval {{ op: \"{}\", indices: {:?}, source: \"{}\" }}",
                operator, arg_indices, source
            );
        }
        TraceEventKind::BranchPrune {
            ...
            println!(
                "  BranchPrune {{ expected: {}, pruned: {}, surviving: {} }}",
                format_trace_value(expected_type),
                pruned_count,
                surviving_count
            );
        ...
        TraceEventKind::ErrorCreated { message, details } => {
            println!(
                "  ErrorCreated {{ msg: \"{}\", details: {} }}",
                message,
                format_trace_value(details)
            );
        }
        TraceEventKind::ErrorCaught {
            ...
            let def = default_used
                .as_ref()
                .map(format_trace_value)
                .unwrap_or_else(|| "None".to_string());
            println!(
                "  ErrorCaught {{ error: {}, handler: \"{}\", default: {} }}",
                format_trace_value(error),
                handler,
                def
            );
        }
        ...
        TraceEventKind::GroundedOpError {
            ...
            println!(
                "  GroundedOpError {{ op: \"{}\", kind: \"{}\", msg: \"{}\" }}",
                op_name, error_kind, message
            );
        }
        ...
        TraceEventKind::BranchStart {
            ...
            println!(
                "  BranchStart {{ index: {}, total: {} }}",
                branch_index, total_branches
            );
        }
        TraceEventKind::BranchEnd {
            ...
            println!(
                "  BranchEnd {{ index: {}, results: {} }}",
                branch_index, result_count
            );
        }
        TraceEventKind::TierDispatch {
            ...
            println!(
                "  TierDispatch {{ hash: 0x{:016x}, tier: {}, exec_count: {} }}",
                expression_hash,
        ...
        TraceEventKind::BytecodeCompilation {
            ...
            println!(
                "  BytecodeCompilation {{ hash: 0x{:016x}, exec_count: {} }}",
                expression_hash, execution_count
            );
        }
        TraceEventKind::JitCompilation {
            ...
            println!(
                "  JitCompilation {{ hash: 0x{:016x}, stage: {}, exec_count: {} }}",
                expression_hash, stage, execution_count
            );
        }
        TraceEventKind::JitBailout {
            ...
            println!(
                "  JIT BAILOUT @ ip={}, reason: {}, fallback: {}",
                bailout_ip, reason, fallback_tier
            );
        }
        ...
        TraceEventKind::GcSafepoint {
            ...
            println!(
                "  GcSafepoint {{ roots: {}, alloc_delta: {} bytes }}",
                root_count, allocation_delta_bytes
            );
        }
        TraceEventKind::TypeInference {
            ...
            println!(
                "  TypeInference {{ expr: {}, types: [{}], source: \"{}\" }}",
                format_trace_value(expression),
                types_str.join(", "),
                source
            );
        }
        TraceEventKind::TypeMatch {
            ...
            println!(
                "  TypeMatch {{ actual: {}, expected: {}, result: {}, reason: \"{}\" }}",
                format_trace_value(actual),
                format_trace_value(expected),
                result,
                reason
            );
        }
        TraceEventKind::RhsTypeComputed {
            head,
            arity,
            lhs,
            rhs,
            ...
            let rt = rhs_type
                ...
                .unwrap_or_else(|| "None".to_string());
            println!(
                "  RhsTypeComputed {{ head: \"{}\", arity: {}, rhs_type: {} }}",
                head, arity, rt
            );
        ...
        TraceEventKind::InferredTypeRegistered {
            ...
            println!(
                "  InferredTypeRegistered {{ fn: \"{}\", type: {}, source: \"{}\" }}",
                function_name,
                format_trace_value(registered_type),
                source
            );
        }
        TraceEventKind::WorkPoolTaskEnqueued {
            ...
            println!(
                "  WorkPoolTaskEnqueued {{ kind: \"{}\", pri: {}, queue: {}, active: {}/{} }}",
        ...
        TraceEventKind::WorkPoolTaskDropped {
            ...
            println!(
                "  WorkPoolTaskDropped {{ kind: \"{}\", queue: {}, active: {} }}",
        ...
        TraceEventKind::WorkPoolTaskCompleted {
            ...
            println!(
                "  WorkPoolTaskCompleted {{ kind: \"{}\", runtime: {}ns, queue: {}, active: {} }}",
        ...
        TraceEventKind::WorkPoolScaleEvent {
            ...
            println!(
                "    ema: tp={:.2}, qd={:.2}, slab={:.3}, rss={:.3}, J={:.4}, emergency={}",
                ema_throughput,
                ema_queue_depth,
                ema_slab_pressure,
                ema_rss_pressure,
        ...
        TraceEventKind::WorkPoolWorkerParked {
            ...
            println!(
                "  WorkPoolWorkerParked {{ worker: {}, queue: {} }}",
                worker_id, queue_depth
            );
        }
        TraceEventKind::WorkPoolWorkerResumed {
            ...
            println!(
                "  WorkPoolWorkerResumed {{ worker: {}, queue: {}, active: {} }}",
        ...
        TraceEventKind::WorkPoolBlockedWorkersDetected {
            ...
            println!(
                "  WorkPoolBlockedWorkersDetected {{ blocked: {}, active: {}, indices: {:?} }}",
        ...
        TraceEventKind::WorkPoolMonitorTick {
            ...
            println!(
                "  WorkPoolMonitorTick {{ evals: {}, elapsed: {}ns, queue: {}, bp: {}, rss: {} }}",
        ...
        TraceEventKind::WorkPoolWorkerBlocked {
            ...
            println!(
                "  WorkPoolWorkerBlocked {{ worker: {}, cpu_ratio: {:.3} }}",
                worker_id, cpu_ratio
            );
        }
        ...
        TraceEventKind::RuleSelected {
            ...
            print!(
                "  RuleSelected {{ index: {selected_index}/{total_matches}, rhs: {selected_rhs}"
            );
            if let Some(span) = rule_span {
                print!(", span: {}:{}", span.start_row, span.start_col);
            }
            println!(" }}");
        }
        TraceEventKind::RuleMatchAttempt {
            ...
            match outcome {
                ...
                trace_format::RuleMatchOutcome::PathNavigateFailed { path, var } => {
                    println!(
                        "    outcome: PathNavigateFailed {{ path: {:?}, var: {:?} }}",
                        path, var
                    );
                }
                trace_format::RuleMatchOutcome::EqualCheckFailed {
                    var,
                    first_value,
                    second_value,
                } => {
        ...
        TraceEventKind::RuleLookup {
            ...
            group_size,
            wildcard_count,
            candidates_after_disc_tree,
            candidates_after_dead_filter,
            final_match_count,
            bloom_filter_reject,
            self_evaluating,
        } => {
        ...
        TraceEventKind::SelfEvaluating {
            ...
            println!(
                "  SelfEvaluating {{ reason: {reason}, candidates_tried: {candidate_count} }}"
            );
        }
